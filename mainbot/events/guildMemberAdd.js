  ...
  async run(client, member) {
    ...
    if (member.user.bot) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "NextGen Bots - Member Join Logs",
      ...
      try {
        const embed = new EmbedBuilder()
          .setTitle("Welcome to NextGen Bots!")
          .setColor("7289da")
          .setDescription(
            `Welcome to NextGen Bots, one of the leading search and discovery platforms for Discord! We are thrilled to have you join our community.\n\n If you have any questions or concerns, please don't hesitate to contact one of our friendly staff members. We hope you have a wonderful day!\n\n Best regards,\nThe NextGen Bots Team`
          )
          .setFooter({
            text: `© NextGen Bots ${new Date().getFullYear()}, All Rights Reserved.`,
