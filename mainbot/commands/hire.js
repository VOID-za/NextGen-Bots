...
module.exports = {
  name: "hire",
  aliases: ["h"],
  description: "Hire a bot reviewer at NextGen Bots.",
  async run(client, message, args) {
    ...
    const logEmbed = new EmbedBuilder()
      ...
      .setDescription(`${member.user} has been hired in NextGen Bots.`)
      .addFields({
        name: "Joined Discord",
    ...
    message.reply(
      `<:yes:946581450852016198> ${user} has been hired in NextGen Bots.`
    );
  },
};
